...
screen.oninput = function (userInput) {
	...
	// exp_container will include math_exp with signs, like "89-6" or "38-38+83x(83 - 4)"
	if (Array.from(screen.value.trim()).some(chr => signs.includes(chr))) {
		exp_container.value = screen.value.trim();
	}
